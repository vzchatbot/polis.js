	...
	switch(pgNo)
	{
		...
		categlist={"facebook":
			{ "text":"I can also sort my recommendations for you by genre. Type or tap below", 
			 "quick_replies":[ 
			    { "content_type":"button", "title":"Comedy", "payload":"show Comedy movies" }, 
			    { "content_type":"button", "title":"Drama", "payload":"show Drama movies" }, 
			    { "content_type":"button", "title":"Sports", "payload":"show Sports movies" }, 
			    { "content_type":"button", "title":"Sci-Fi & Fantasy", "payload":"show Sci-Fi movies" },
			    { "content_type":"button", "title":"More Categories ", "payload":"show categories list pageno: 1" }
			 ] }};
